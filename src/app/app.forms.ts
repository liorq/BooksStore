...
title: 'Edit book',
    html:
      ...
      `<div>Please enter the new ID for the book.</div>   <input id="swal-input3" class="swal2-input"  value=${book.id}>` +
      `<div>Please enter the new author name for the book.</div> <input id="swal-input4" class="swal2-input" value=${book.author}>`,
    focusConfirm: false,
    preConfirm: () => {
      return [
